...
Some members abstained because the Info Action concerning the Net Change Limit is intended to record the views of DReps, and the Net Change Limit itself is a matter for DReps to decide rather than the Constitutional Committee.
